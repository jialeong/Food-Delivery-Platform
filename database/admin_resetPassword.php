...
if (isset($_POST["password"])) {
    ...
    $query = mysqli_query($conn, "UPDATE admin_login SET admin_password='$new_password' WHERE admin_email='$email'");

    if ($query) {
        $query = mysqli_query($conn, "DELETE FROM reset_password WHERE code='$code'");
        exit("<h3>Congratulations Admin! The password has been updated.</h3>");
    }
    else {
    ...
    <form method="POST" name="forget_password_Form" onsubmit="return(ValidateEmail());">
        ...
        <div class="Forgot_Passowrd_Container">
            ...
            <div class="Welcome_Statement">
                <p class="text-primary">Admin please create your new password. &#128521;</p>
            </div>
            ...
            <div class="Forgot_Passowrd_ResetNow_Button">
                <button class="btn btn-success" type="submit" name="submit" value="Reset password">Reset Now</button>
            </div>
